...
=head1 Un-Escaping \ of \N, \p, \P, and \X (EUCJP software provides)

EUCJP software removes '\' at head of alphanumeric regexp metasymbols \N, \p, \P
...
=head1 Escaping Built-in Functions (EUCJP software provide)
