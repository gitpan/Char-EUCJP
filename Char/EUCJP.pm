...
impossible. Char::EUCJP software is Perl program designed to make the "easy jobs easy".
...
Contrasting is Encode module and describing "use Char::EUCJP;" on this software,
