...
sub Char::EUCJP::escape_script {
    ...
    if (/^ use Char::Eeucjp(?:\s+[0-9\.]*)?\s*; $/oxms) {
        ...
        # use Char::EUCJP version qw(ord reverse);
        $function_ord     = 'ord';
        $function_ord_    = 'ord';
...
=head1 SYNOPSIS
  ...
  use Char::EUCJP qw(ord reverse); --- demand enhanced feature of ord and reverse
  use Char::EUCJP ver.sion qw(ord reverse);
  use Char::EUCJP ver.sion.0 qw(ord reverse);
