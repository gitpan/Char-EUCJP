...
http://search.cpan.org/dist/Char-Char::EUCJP/Char::EUCJP/JA.pm
...
Definitions in Char/Eeucjp.pm.
  ...
  @{Char::Eeucjp::eV}             qr{(?:\x8F[\xA1-\xFE][\xA1-\xFE]|[\x8E\xA1-\xFE][\x00-\xFF]|[^\x8E\x8F\xA1-\xFE\x0C\x0A\x0D])}
...
=item * Length By EUC-JP Character
  ...
  $string is omitted, it returns the Char::EUCJP::length of $_.
...
=item * Substr By EUC-JP Character
  ...
  area past the end of the string, Char::EUCJP::substr raises an exception.
...
=item * Rindex By EUC-JP Character
  ...
  $rindex = Char::EUCJP::rindex($string,$substring,$position);
  $rindex = Char::EUCJP::rindex($string,$substring);

  This function works just like Char::EUCJP::index except that it returns the position of
