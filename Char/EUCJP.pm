...
my $m_matched   = '';
my $s_matched   = '';
$m_matched   = q{@Char::Eeucjp::m_matched};
...
=head1 Escaping Multiple Octet Code (Char/EUCJP.pm provides)
...
functions.
  ...
  index       Char::Eeucjp::index
  rindex      Char::Eeucjp::rindex
  chr         Char::Eeucjp::chr
  glob        Char::Eeucjp::glob
  ---------------------------------
...
=item * Reverse List Or String
  ...
  %barfoo = Char::EUCJP::reverse(%foobar);
...
=item * Special Variables $` And $& Doesn't Function
  ...
  is escaped to
    'AAABBBCCC' =~ /\G(?:\x8F[\xA1-\xFE][\xA1-\xFE]|[\x8E\xA1-\xFE][\x00-\xFF]|[^\x8E\x8F\xA1-\xFE])*?(?:BBB)@Char::Eeucjp::m_matched/;
