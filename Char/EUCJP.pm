...
# functions of package Char::Eeucjp
...
=item * Returns Next Character
  ...
  If you import getc "use Char::EUCJP qw(getc);", getc of your script will be rewritten in
  Char::EUCJP::getc. Char::EUCJP::getc is not compatible with getc of JPerl.
...
=item * Length by EUC-JP Character
  ...
  the scalar value $string. If $string is omitted, it returns the Char::EUCJP::length of
  $_.
...
=item * Substr by EUC-JP Character
  ...
  If Perl version 5.14 or later, you can use the Char::EUCJP::substr() function as an
...
=item * Rindex by EUC-JP Character
  ...
  This function works just like Char::EUCJP::index except that it returns the character
...
=item * Filename Globbing
  ...
  This operator is implemented via the Char::Eeucjp::glob() function. See Char::Eeucjp::glob of
  Char/Eeucjp.pm for details.
...
=head1 Un-Escaping bytes::* Functions (Char/EUCJP.pm provides)

Char/EUCJP.pm removes 'bytes::' at head of function name.
...
Char::EUCJP::substr differs from CORE::substr, and cannot be used as a lvalue.
