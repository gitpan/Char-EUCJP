...
=item Make character
  ...
  set. For example, Char::Eeucjp::chr(65) is "A" in either ASCII or EUC-JP, not Unicode,
  and Char::Eeucjp::chr(0x82a0) is a EUC-JP HIRAGANA LETTER A. For the reverse of
  Char::Eeucjp::chr, use Char::EUCJP::ord.
