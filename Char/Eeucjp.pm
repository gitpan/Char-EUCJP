...
# regexp of character
BEGIN { CORE::eval q{ use vars qw($your_char) } } $your_char = q{\x8F[\xA1-\xFE][\xA1-\xFE]|[\x8E\xA1-\xFE][\x00-\xFF]|[\x00-\xFF]};
...
${Char::Eeucjp::anchor}      = qr{\G(?:\x8F[\xA1-\xFE][\xA1-\xFE]|[\x8E\xA1-\xFE][\x00-\xFF]|[^\x8E\x8F\xA1-\xFE])*?}oxms;
BEGIN { CORE::eval q{ use vars qw(
...
if (($] >= 5.010001) or
    ...
    # other encoding
        ...
        ${Char::Eeucjp::q_char_SADAHIRO_Tomoyuki_2002_01_17} = qr{.*?[$sbcs](?:$tbcs_1st[^$sbcs]{2})*?}oxms;
    }

    ${Char::Eeucjp::anchor_SADAHIRO_Tomoyuki_2002_01_17} =
    qr{\G(?(?=.{0,32766}\z)(?:\x8F[\xA1-\xFE][\xA1-\xFE]|[\x8E\xA1-\xFE][\x00-\xFF]|[^\x8E\x8F\xA1-\xFE])*?|(?(?=[$sbcs]+\z).*?|(?:${Char::Eeucjp::q_char_SADAHIRO_Tomoyuki_2002_01_17})))}oxms;
#   qr{
#      \G # (1), (2)
#        (? # (3)
#          (?=.{0,32766}\z) # (4)
...
#                                                                                      (?(?=[$sbcs]+\z) # (6)
#                                                                                                      .*?| #(7)
#                                                                                                          (?:${Char::Eeucjp::q_char_SADAHIRO_Tomoyuki_2002_01_17}) # (8)
#                                                                                                                                                           ))}oxms;

    # avoid: Complex regular subexpression recursion limit (32766) exceeded at here.
    local $^W = 0;

    if (((('A' x 32768).'B') !~ / ${Char::Eeucjp::anchor}                              B /oxms) and
        ((('A' x 32768).'B') =~ / ${Char::Eeucjp::anchor_SADAHIRO_Tomoyuki_2002_01_17} B /oxms)
    ) {
        ${Char::Eeucjp::anchor} = ${Char::Eeucjp::anchor_SADAHIRO_Tomoyuki_2002_01_17};
    }
    else {
        undef ${Char::Eeucjp::q_char_SADAHIRO_Tomoyuki_2002_01_17};
    }
}
...
# avoid: Name "Char::Eeucjp::foo" used only once: possible typo at here.
${Char::Eeucjp::dot}         = ${Char::Eeucjp::dot};
${Char::Eeucjp::dot_s}       = ${Char::Eeucjp::dot_s};
${Char::Eeucjp::eD}          = ${Char::Eeucjp::eD};
${Char::Eeucjp::eS}          = ${Char::Eeucjp::eS};
${Char::Eeucjp::eW}          = ${Char::Eeucjp::eW};
${Char::Eeucjp::eH}          = ${Char::Eeucjp::eH};
${Char::Eeucjp::eV}          = ${Char::Eeucjp::eV};
${Char::Eeucjp::eR}          = ${Char::Eeucjp::eR};
${Char::Eeucjp::eN}          = ${Char::Eeucjp::eN};
${Char::Eeucjp::not_alnum}   = ${Char::Eeucjp::not_alnum};
${Char::Eeucjp::not_alpha}   = ${Char::Eeucjp::not_alpha};
${Char::Eeucjp::not_ascii}   = ${Char::Eeucjp::not_ascii};
${Char::Eeucjp::not_blank}   = ${Char::Eeucjp::not_blank};
${Char::Eeucjp::not_cntrl}   = ${Char::Eeucjp::not_cntrl};
${Char::Eeucjp::not_digit}   = ${Char::Eeucjp::not_digit};
${Char::Eeucjp::not_graph}   = ${Char::Eeucjp::not_graph};
${Char::Eeucjp::not_lower}   = ${Char::Eeucjp::not_lower};
${Char::Eeucjp::not_lower_i} = ${Char::Eeucjp::not_lower_i};
${Char::Eeucjp::not_print}   = ${Char::Eeucjp::not_print};
${Char::Eeucjp::not_punct}   = ${Char::Eeucjp::not_punct};
${Char::Eeucjp::not_space}   = ${Char::Eeucjp::not_space};
${Char::Eeucjp::not_upper}   = ${Char::Eeucjp::not_upper};
${Char::Eeucjp::not_upper_i} = ${Char::Eeucjp::not_upper_i};
${Char::Eeucjp::not_word}    = ${Char::Eeucjp::not_word};
${Char::Eeucjp::not_xdigit}  = ${Char::Eeucjp::not_xdigit};
${Char::Eeucjp::eb}          = ${Char::Eeucjp::eb};
${Char::Eeucjp::eB}          = ${Char::Eeucjp::eB};
...
sub Char::Eeucjp::split(;$$$) {
    ...
    if (CORE::length($string) > 32766) {
        ...
        elsif (defined ${Char::Eeucjp::q_char_SADAHIRO_Tomoyuki_2002_01_17}) {
            $q_char = ${Char::Eeucjp::q_char_SADAHIRO_Tomoyuki_2002_01_17};
        }
    }
...
sub Char::EUCJP::getc(;*@) {
    ...
    croak 'Too many arguments for Char::EUCJP::getc' if @_ and not wantarray;
    ...
    for my $length ($length[0] .. $length[-1]) {
        ...
        if (exists $range_tr{CORE::length($getc)}) {
            if ($getc =~ /\A ${Char::Eeucjp::dot_s} \z/oxms) {
...
sub Char::EUCJP::escape(;$) {
    ...
    while (not /\G \z/oxgc) { # member
        $e_script .= Char::EUCJP::escape_token();
    }
...
# subroutines of package Char::Eeucjp
    ...
    elsif (/\G \b Char::EUCJP::eval       (?= \s* \{ )                /oxgc) { $slash = 'm//'; return 'eval';              }
    elsif (/\G \b Char::EUCJP::eval    \b (?! \s* => )                /oxgc) { $slash = 'm//'; return 'eval Char::EUCJP::escape'; }
...
# subroutines of package Char::Eeucjp
        ...
        elsif ($string =~ /\G \b Char::EUCJP::eval       (?= \s* \{ )                /oxgc) { $e_string .= 'eval';              $slash = 'm//'; }
        elsif ($string =~ /\G \b Char::EUCJP::eval \b                                /oxgc) { $e_string .= 'eval Char::EUCJP::escape'; $slash = 'm//'; }
...
sub e_sub {
    ...
    if ($r_modifier) {
        ...
        # s///gr with multibyte anchoring
            ...
            $sub = sprintf(
                #                              1                                              2   3                                 4   5
                q<CORE::eval{local $Char::EUCJP::re_t=%s; local $Char::EUCJP::re_a=''; while($Char::EUCJP::re_t =~ %s){%s local $^W=0; local $Char::EUCJP::re_r=%s; %s$Char::EUCJP::re_t="$Char::EUCJP::re_a${1}$Char::EUCJP::re_r$'"; pos($Char::EUCJP::re_t)=length "$Char::EUCJP::re_a${1}$Char::EUCJP::re_r"; $Char::EUCJP::re_a=substr($Char::EUCJP::re_t,0,pos($Char::EUCJP::re_t)); } return $Char::EUCJP::re_t}>,
                ...
                $s_matched,                                                      #  3
                $e_replacement,                                                  #  4
                '$Char::EUCJP::re_r=CORE::eval $Char::EUCJP::re_r; ' x $e_modifier,            #  5
            );
        }
        ...
        # s///gr without multibyte anchoring
            ...
            $sub = sprintf(
                #                              1                        2   3                                 4   5
                q<CORE::eval{local $Char::EUCJP::re_t=%s; while($Char::EUCJP::re_t =~ %s){%s local $^W=0; local $Char::EUCJP::re_r=%s; %s$Char::EUCJP::re_t="$`$Char::EUCJP::re_r$'"; pos($Char::EUCJP::re_t)=length "$`$Char::EUCJP::re_r"; } return $Char::EUCJP::re_t}>,
        ...
        # s///r
            ...
            $sub = sprintf(
                #  1     2                3                                 4   5  6                    7
                q<(%s =~ %s) ? CORE::eval{%s local $^W=0; local $Char::EUCJP::re_r=%s; %s"%s$Char::EUCJP::re_r$'" } : %s>,
    ...
    # without /r
        ...
        # s///g with multibyte anchoring
            ...
            $sub = sprintf(
                ...
                q<CORE::eval{local $Char::EUCJP::re_n=0; local $Char::EUCJP::re_a=''; while(%s =~ %s){%s local $^W=0; local $Char::EUCJP::re_r=%s; %s%s="$Char::EUCJP::re_a${1}$Char::EUCJP::re_r$'"; pos(%s)=length "$Char::EUCJP::re_a${1}$Char::EUCJP::re_r"; $Char::EUCJP::re_a=substr(%s,0,pos(%s)); $Char::EUCJP::re_n++} return %s$Char::EUCJP::re_n}>,
...
# (and so on)
        ...
        # s///g without multibyte anchoring
            ...
            $sub = sprintf(
                #                                       1     2   3                                 4   5 6                         7                                                 8
                q<CORE::eval{local $Char::EUCJP::re_n=0; while(%s =~ %s){%s local $^W=0; local $Char::EUCJP::re_r=%s; %s%s="$`$Char::EUCJP::re_r$'"; pos(%s)=length "$`$Char::EUCJP::re_r"; $Char::EUCJP::re_n++} return %s$Char::EUCJP::re_n}>,
        ...
        # s///
            ...
            $sub = sprintf(
                ...
                #  1 2 3                4                                 5   6 7   8
                q<(%s%s%s) ? CORE::eval{%s local $^W=0; local $Char::EUCJP::re_r=%s; %s%s="%s$Char::EUCJP::re_r$'"; 1 } : undef> :

                #  1 2 3                    4                                 5   6 7   8
                q<(%s%s%s) ? 1 : CORE::eval{%s local $^W=0; local $Char::EUCJP::re_r=%s; %s%s="%s$Char::EUCJP::re_r$'"; undef }>,
                ...
                $s_matched,                                                      #  4
                $e_replacement,                                                  #  5
                '$Char::EUCJP::re_r=CORE::eval $Char::EUCJP::re_r; ' x $e_modifier,            #  6
                $variable,                                                       #  7
                $prematch,                                                       #  8
            );
        }
...
This module has run-time routines for use Char::EUCJP software automatically, you
do not have to use.
