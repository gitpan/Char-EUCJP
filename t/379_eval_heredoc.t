...
# eval <<END has eval "..."
if (eval Char::EUCJP::escape <<END) {
eval Char::EUCJP::escape " if ('¢¢¡ü' !~ /¢¡/) { return 1 } else { return 0 } "
END
...
if (eval Char::EUCJP::escape <<END) {
eval Char::EUCJP::escape qq{ if ('¢¢¡ü' !~ /¢¡/) { return 1 } else { return 0 } }
END
...
# eval <<END has eval '...'
if (eval Char::EUCJP::escape <<END) {
eval Char::EUCJP::escape ' if (qq{¢¢¡ü} !~ /¢¡/) { return 1 } else { return 0 } '
END
...
# eval <<END has eval q{...}
if (eval Char::EUCJP::escape <<END) {
eval Char::EUCJP::escape q{ if ('¢¢¡ü' !~ /¢¡/) { return 1 } else { return 0 } }
END
